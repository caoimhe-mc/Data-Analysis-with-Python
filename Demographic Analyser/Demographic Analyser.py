...
def calculate_demographic_data(print_data=True):
    # Read data from file
    df = pd.read_csv('C:/Users/Caoimhe/Documents/Data Analysis with Python/adult.data.csv', header = 0)
    ...
    numberBachelors = df.loc[df['education'] == 'Bachelors'].shape[0]
    percentage_bachelors = (numberBachelors/totalRows)*100
    ...
    rich_percentage = round(len(df[(df["hours-per-week"] == num_min_workers) & (df["salary"] == ">50K")]) / num_min_workers * 100, 1)
